...
Bureaucrat::FailedToExecuteException::FailedToExecuteException(const char *_message):
    std::runtime_error(_message) {}

const char* Bureaucrat::FailedToExecuteException::what() const _NOEXCEPT {
    return "Bureaucrat: Failed to execute a form.";
}
